...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <a class="navbar-brand" href="#">SANSTAY</a>
    ...
    <div class="hero-wrap js-fullheight img" style="background-image: url(assets/images/bg_3.jpg);">
      ...
      <div class="container-fluid px-0">
        <div class="row d-md-flex no-gutters slider-text align-items-center js-fullheight justify-content-center">
            <div class="col-md-8 text-center d-flex align-items-center ftco-animate js-fullheight">
                <div class="text mt-5">
                    <span class="subheading">Sistem Pendataan Homestay</span>
                <h1 class="mb-3">Sanstay memudahkan dalam pendataan homestay dan pencarian homestay.</h1>
                </div>
            </div>
            </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <h2 class="mb-4">Kenapa harus pake SANSTAY?</h2>
            <p>Lebih mudah dalam pendataan homestay dari segi pemilik maupun dinas.</p>
			<p>Media publikasi untuk pencarian homestay di area Yogyakarta</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section ftco-counter bg-light img" id="section-counter">
        <div class="container">
          ...
          <div class="col-md-10 text-center heading-section ftco-animate">
            <h2 class="mb-4">Data dari Badan Pusat Statistik Daerah Istimewa Yogyakarta (BPS DIY), saat ini di Yogyakarta
            terdapat lebih dari 1000 homestay yang tersebar di empat kota/kabupaten dan dikelola secara mandiri
            oleh perusahaan atau perorangan.</h2>
          </div>
        </div>
          ...
          <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
            <div class="block-18 text-center">
              <div class="text">
                <strong class="number" data-number="1250">0</strong>
                <span>Homestay di Yogyakarta</span>
              </div>
            </div>
          </div>
          <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
          ...
          <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
            <div class="block-18 text-center">
              <div class="text">
                ...
                <span>Homestay Belum Terdaftar</span>
              </div>
            </div>
          </div>
          <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
            <div class="block-18 text-center">
              <div class="text">
                ...
                <span>Turis hadir setiap tahunnya</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm ftco-animate">
                    <a href="https://laravel.com" class="partner"><img src="assets/images/laravel.png" class="img-fluid" alt="Colorlib Template"></a>
                </div>
				<div class="col-sm ftco-animate">
                    <a href="https://sublimetext.com" class="partner"><img src="assets/images/sublime.png" class="img-fluid" alt="Colorlib Template"></a>
                </div>
                <div class="col-sm ftco-animate">
                    <a href="https://phpmyadmin.net" class="partner"><img src="assets/images/phpmyadmin.png" class="img-fluid" alt="Colorlib Template"></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="ftco-section testimony-section">
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <h2 class="mb-4">Our Member Team</h2>
            <p>Tanpa kerjasama tim, tidak mungkin memberi hasil yang maksimal.</p>
          </div>
        </div>
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
			  <div class="item">
                <div class="testimony-wrap p-4 text-center">
                  <div class="user-img mb-4" style="background-image: url(assets/images/person_1.png)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
                  <div class="text">
				  <p class="name">Aulia Rahman</p>
                    <span class="position">Project Manager, Developer</span>
                  </div>
                </div>
              </div>
				<div class="item">
                <div class="testimony-wrap p-4 text-center">
                  ...
                  <div class="text">
				  <p class="name">Aditya Wibisono Kuncoro</p>
                    <span class="position">Developer, Documentator</span>
                  </div>
                </div>
              </div>
        <div class="item">
                <div class="testimony-wrap p-4 text-center">
                  ...
                  <div class="text">
          <p class="name">Andhika Rizky Aryasta</p>
                    <span class="position">Developer, Tester</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              <h2 class="ftco-heading-2">Projek dikerjakan dengan</h2>
